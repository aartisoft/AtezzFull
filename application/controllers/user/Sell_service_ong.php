...
class Sell_service_ong extends CI_Controller{
    ...
    {			
...

		{
			...
			$this->data['module']			= 'sell_service_ong';       
			...
			$this->data['categories_subcategories'] = $this->user_panel_model->tipoServico_ong(); 
    ...
    {     
       ...
       { 
		...
		$dataOng['id_members'] = $uid; 
		$dataOng['id_cadastro_ong'] = $idOng; 
		$dataOng['id_sell_gigs'] = $gigs_id;
		

	   $this->db->insert('sell_post_ong', $dataOng);
