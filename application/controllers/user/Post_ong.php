...
class Post_ong extends CI_Controller{
    ...
    {			
		...
		if(!empty($uid))
		{
			$userid = $this->User_panel_model->verify_Ong($uid); 
		}
		else
		{
			$userid = null;
    ...
    {   
...

		{
			...
			$this->data['page_title'] = 'Postar Ong';
    ...
    //    }    
       ...
       $this->session->set_flashdata('msg','Gig added');
