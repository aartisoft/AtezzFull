...
class Lista_ong extends CI_Controller{
...
{  
	...
	$this->data['page_title'] = 'Lista de Ongs Cadastradas';

	$this->load->library('pagination');

	$config['base_url'] = base_url().'lista-ong';

	$config['per_page'] = 16;                

	$config['total_rows'] =  $this->gigs_model->ong_lista(0,0,0);   
	...
	$this->data['module'] = 'lista_ong';

	$this->data['page'] = 'index';

	$this->data['search_value'] = 'Projetos Cadastrados';    
