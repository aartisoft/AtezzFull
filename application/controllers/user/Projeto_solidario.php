...
class Projeto_solidario extends CI_Controller{
...
{  
    ...
    $config['base_url'] = base_url().'projeto_solidario';
    ...
    $this->data['module'] = 'projeto_solidario';

    $this->data['page'] = 'index';

    $this->data['search_value'] = 'Projetos Solidários';   
