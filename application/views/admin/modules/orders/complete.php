<div class="content-page">
	<div class="content">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<h4 class="page-title m-b-20 m-t-0">Pedidos Finalizados</h4>
				</div>
			</div>
             <div class="row">
				<div class="col-lg-12">
							...
							<table class="table table-actions-bar datatable m-b-0">
								...
								<tbody>
									...
									foreach($list as $item) { 
										...
										if($payment_status ==1) {
											$pay_status='Payment requst from seller';
									...
									<tr>                                                    
										...
										<td><span class="label <?php echo $class;?>"><?php echo $pay_status;?></span></td>
									</tr>
									<?php } } else { ?>
									<tr>
