<div class="content-page">
    <div class="content">	
		...
		<?php if($this->session->userdata('message')) {  ?>
			...
			<div class="row">
				<div class="col-sm-12">
					<form class="form-horizontal" action="<?php echo base_url().'admin/payment_gateway/edit/'.$list['id']; ?>" method="post">
						<div class="card-box">
					...
					<div class="card-box">
						...
						<div class="clearfix"></div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Rest Key</label>
								<div class="col-sm-9">
							...
							<div class="text-center m-t-30">
								...
								<a href="<?php echo base_url().'admin/payment_gateway' ?>" class="btn btn-default m-l-5">Cancel</a>
							</div>
						</div>
					</form>
				</div>
