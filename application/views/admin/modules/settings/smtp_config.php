        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
					...
					<?php } ?>
                    <h4 class="page-title m-b-20 m-t-0">Configuração de Smtp</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
