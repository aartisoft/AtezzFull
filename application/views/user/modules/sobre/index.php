				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-12 sell-banner-cont">
								<div class="banner-solidario" style="background-color:rgba(36,72,54,0.3);padding:60px 0px 10px 0px" width="300px" height="100px" >
								...
								<?php if(empty($verify_user_premium)){ ?> 								 
									...
									<a href="javascript:;"  data-toggle="modal" data-target="#login-popup">
										<button type="button" class="btn btn-success btn-lg">Indique uma ONG</button>
									</a>										
			...
			<section class="container">
				...
				<div class="row" align="center" >
							...
							<div class="col-md-12" align="center">
								<h1><b><span text-align="center">Como posso ajudar</span></b></h1> <br/>
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi molestie tellus tincidunt nunc aliquam, at imperdiet sapien dapibus. Nullam suscipit, sapien id porttitor mollis, ex mauris dictum est, eget tempus sapien sem sit amet arcu. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi molestie tellus tincidunt nunc aliquam, at imperdiet sapien dapibus. Nullam suscipit, sapien id porttitor mollis, ex mauris dictum est, eget tempus sapien sem sit amet arcu. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi molestie tellus tincidunt nunc aliquam, at imperdiet sapien dapibus. Nullam suscipit, sapien id porttitor mollis, ex mauris dictum est, eget tempus sapien sem sit amet arcu.								
							</div>
