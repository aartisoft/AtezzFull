...
?>
	...
	?>
								...
								<p class="gig-detail">Criado <?php echo $time_taken; ?></p> 
						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<div class="gig-info-list">
									...
									<span class="gig-deliver">Compartilhar em minhas redes<?php echo $display_days; ?><span class="gig-count">  </span></span>
           ...
           <div class="delivery-block clearfix">
							...
							<div class="view-right">
								...
								<div class="order-btn theiaStickySidebar" >
                                     ...
                                     if($this->session->userdata('SESSION_USER_ID'))   {  
                                        ...
                                        if($this->session->userdata('SESSION_PROVIDER') || "" ){
                                        ?> 
                                            <a href="#" class="btn" onclick="check_extra_gigs()" data-toggle="modal" data-target="#checkout-popup2">Contribuir <?php //echo $rate_symbol ;?><span id="over_all_total"><?php //echo $rate; ?></span></a>
                                        <?php 
                                        }else{?>
                                            <a href="#" class="btn" data-toggle="modal" data-target="#checkout-popup">Contribuir<?php //echo $rate_symbol ;?><span id="over_all_total"><?php //echo $rate; ?></span></a>
                                        <?php }
										...
										<?php if(($this->session->userdata('SESSION_USER_ID'))!=$user_profile['USERID'] )   {  ?> 
                                                                                ...
                                                                                <li class="seller-contact"><img alt="views" src="<?php echo base_url()."assets/images/contact.png";?>" width="33" height="33">                                                                                    
                                                                                  ...
                                                                                  <?php if(($this->session->userdata('SESSION_USER_ID')))  { 
                                                                                    ...
                                                                                    <a href="javascript:;" data-toggle="modal" data-target="#message-popup"><h5>Falar com o responsável</h5></a>

                                                                                  <?php } else { ?>

                                                                                    <a href="javascript:;" onclick="selected_menu('sell-service')" ><h5>Falar com o responsável</h5></a>
								...
								<div class="seller-info">
									...
									<ul class="gig-stats seller-stats">
										...
										<li class="seller-views"><img alt="views" src="<?php echo base_url()."assets/images/view.png"?>" width="34" height="34"> <h5><?php echo $gig_details['total_views']; ?> Visualizações</h5></li>

										<li class="seller-orders"><img alt="views" src="<?php echo base_url()."assets/images/orders.png";?>" width="36" height="36"> <h5><?php echo count($result_countid);?> Apoiando este projeto</h5></li>
			...
			<div class="page-section">
                ...
                <div class="container">
                    ...
                    <h2 class="other-gigs-title">Outros Projetos em destaque<span> <br/><br/>
...
$rate_symbol = currency_sign($currency_option);
									...
									<div class="product">  
										...
										<div class="product-detail">
                                           	...
                                           	<div class="product-name"><a href="<?php echo base_url().'ong-preview/'.$gigs['title']; ?>"><?php echo ucfirst(str_replace("-"," ",$gigs['title'])); ?></a></div>
            ...
            <div id="checkout-popup2" class="modal fade custom-popup order-popup" role="dialog">
				...
				<div class="modal-dialog">
					...
					<div class="modal-content">
						...
						<div class="modal-header text-center">
                            ...
                            <br/>
							<h4 class="sign-title">Desejo contribuir</h4><br/>
                            <span>Adicione este projeto em sua lista de causas que você apoia e alcance <br/>ainda mais ajudando quem necessita.</span>

						</div>
						<div class="modal-body">
                            <div class="col-2" align="center"><br/>
                                    <form>
                                    <label class="label-title">Porcentagem de doação</label><br/>
                                    <select name="cars" width="90px">
                                        <option value="5">Contribuir com 5%</option>
                                        <option value="10">Contribuir com 10%</option>
                                        <option value="15">Contribuir com 15%</option>
                                        <option value="25">Contribuir com 25%</option>
                                    </select><br/><br/><br/><br/>
                                    
                                    <div class="order-btn theiaStickySidebar" >
                                        <a href="#" class="btn btn-sucesso" onclick="check_extra_gigs()" data-toggle="modal" data-target="#checkout-popup2">Salvar</span></a>
                                    </div>    
                                    </form>
                            </div><br/><br/>


							<form  hidden="true"  action="<?php echo base_url().'user/buy_service/payment';?>" method="post" id="payment_formid" name="payment_submit">
				...
				<div class="modal-dialog">
					...
					<div class="modal-content">
						...
						<div class="modal-header text-center">
                            ...
                            <br/>
							<h4 class="sign-title">Contribua para esta causa</h4><br/>
                            <span>Com apenas 1 Real, você pode ajudar a garantir a continuidade<br/> deste trabalho.<strong> Nos ajude nesta causa.</strong></span>
						...
						<div class="modal-body">
                            <div class="col-2" align="center">
                                <table>
                                        <tr>
                                            <td class="col-2" width="80px"><b> Banco</b></td>
                                            <td><?php echo strtoupper($Banco) ?></td>
                                        </tr>
                                        <tr>
                                            <td class="col-2" width="80px"><b>Agência</b></td>
                                            <td><?php echo $Agencia ?></td>
                                        </tr>
                                        <tr>
                                            <td class="col-2" width="80px"><b>Conta</b></td>
                                            <td><?php echo $Conta ?></td>
                                        </tr>
                                        <tr>
                                            <td class="col-2" width="80px"><b>CNPJ/CPF</b></td>
                                            <td><?php echo $Cnpj ?></td>
                                        </tr>
                                        <tr>
                                            <td class="col-2" width="80px"><b>Titular</b></td>
                                            <td><?php echo $Nome ?></td>
                                        </tr>
                                </table>
                            </div><br/><br/>
						...
						<div class="modal-footer text-left">
							...
							<div class="media secure-money">
								...
								<div class="media-body">
									...
									<span align="center">Envie o comprovante de transferência por e-mail, para que possamos identificar sua doação. </span>
