				...
				<div class="container">		
					...
					<div class="row">
						...
						<div class="col-md-8 col-sm-12">                                                   
							...
							<h3 class="post-gig-title">Descreva o serviço social que sua Ong realiza.</h3>
							...
							<form id="sell_service"   action="<?php echo base_url()."user/post_ong/add_gigs"; ?>" method="post" class="sell-service-form" enctype= "multipart/form-data" >
								...
								<div class="form-group clearfix">
									...
									<div class="name-block">
										...
										<span class="name-input">
											<input type="text" name="gig_title" id="gig_title" onkeyup="gig_title_check(this)" onchange="gig_title_check(this)" value="" class="form-control gig-name " maxlength="80" placeholder="Título	">	
										</span>
								...
								<input type="text" name="delivering_time" id="delivering_time" class="form-control" maxlength="2" onkeyup="max_lenght(this)" onchange="max_lenght(this)" placeholder="Just type number of days (ex : 2 Days)"><span class="actual_delivery_days" id="main_delivery_days"> </span>
								...
								<div class="form-group add-image clearfix">
									...
									<label class="label-title">Adicione imagens, ou vídeos. <span class="text-muted" style="color:#999;">(imagem <span class="required">*</span>)</span></label>
								...
								<div class="form-group item-description clearfix">
									...
									<label class="label-title">Descreva com detalhes as atividades que a instituição realiza <span class="required">*</span></label>
...
<div class="name-block2">
	...
	<input type="text" class="form-control amount numberonly" name="extra_gigs_amount[]" data-bv-field="extra_gigs_amount[]" <?php // echo ($allow==1)?'':'readonly'; ?> onfocusout="inputfocusout(this)" id='label_val_1' value="<?php echo ($allow==1)?'':$extra_gig_price ?>">
...
<div class='clearfix extra-gig-option' id='row_id_#' >
    ...
    <div class='name-block2'>
        ...
        <span class='currency'>for <span class='currency-group'><?php echo $currency_sign; ?> <input type='text' class='form-control amount numberonly' name='extra_gigs_amount[]' data-bv-field='extra_gigs_amount[]' onfocusout="inputfocusout(this)" <?php // echo ($allow==1)?'':'readonly'; ?> id='label_val_#' value='_0_'></span> in <input type='text'   class='form-control amount2 numberonly addmore' value='1' onkeypress='return event.charCode >= 48 && event.charCode <= 57'  onkeyup='extra_gig_days(this,1)'  onfocusout='inputfocusout(this)' onmouseup='extra_gig_days(this,1)'  name='extra_gigs_delivery[]'>
